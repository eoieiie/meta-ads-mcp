...
function fullReport(overrides?: Partial<DeathmatchReport>): DeathmatchReport {
  return {
    ...
    score: {
      championCPPV: 100,
      challengerCPPV: 62.5,
      championSaveRate: (50 + 5) / 3000,
      challengerSaveRate: (40 + 3) / 2000,
      championCTR: 200 / 5000,
      challengerCTR: 100 / 3000,
      championFrequency: 5000 / 3000,
      challengerFrequency: 3000 / 2000,
      costScore: (100 / 62.5) * 60,
      attrScore: Math.min(((43 / 2000) / (55 / 3000)) * 20, 40),
      ctrScore: Math.min(((100 / 3000) / (200 / 5000)) * 20, 40),
      penalty: 0,
      challengerHS: (100 / 62.5) * 60 + Math.min(((43 / 2000) / (55 / 3000)) * 20, 40) + Math.min(((100 / 3000) / (200 / 5000)) * 20, 40),
      championHS: 100,
      winner: "challenger",
    },
    dailyRows: [
      {
        date: "2026-05-21",
        champion: { spendKrw: 2000, impressions: 1000, reach: 600, instagramProfileVisits: 20, saves: 10, shares: 1, likes: 6, linkClicks: 40, actions: [], raw: null },
        challenger: { spendKrw: 1000, impressions: 600, reach: 400, instagramProfileVisits: 16, saves: 8, shares: 0, likes: 4, linkClicks: 20, actions: [], raw: null },
      },
    ],
    ...overrides,
  };
    ...
    dailyRows: [
      {
        date: "2026-05-21",
        champion: { spendKrw: 2000, impressions: 1000, reach: 600, instagramProfileVisits: 20, saves: 10, shares: 1, likes: 6, linkClicks: 40, actions: [], raw: null },
        challenger: { spendKrw: 0, impressions: 0, reach: 0, instagramProfileVisits: 0, saves: 0, shares: 0, likes: 0, linkClicks: 0, actions: [], raw: null },
      },
    ],
  });
...
test("shows zero spend explanation when spend is 0", () => {
  const report = fullReport({
    championMetrics: { spendKrw: 0, impressions: 0, reach: 0, instagramProfileVisits: 0, saves: 0, shares: 0, likes: 0, linkClicks: 0, actions: [], raw: null },
    challengerMetrics: { spendKrw: 0, impressions: 0, reach: 0, instagramProfileVisits: 0, saves: 0, shares: 0, likes: 0, linkClicks: 0, actions: [], raw: null },
    score: {
      championCPPV: 0,
      challengerCPPV: 0,
      championSaveRate: 0,
